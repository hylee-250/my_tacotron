...
class Tacotron2(nn.Module):
    ...
    def parse_batch(self, batch):
        ...
        return (
            (text_padded, input_lengths, r_len_pad, mel_padded, max_len, output_lengths,
            speaker_ids),
    ...
    def forward(self, inputs):
        text_inputs, text_lengths,r_len_pad, mels, max_len, output_lengths, speaker_ids = inputs
        ...
        #     (encoder_outputs, embedded_gst, embedded_speakers), dim=2)
        encoder_outputs = encoder_outputs + embedded_gst + embedded_speakers
